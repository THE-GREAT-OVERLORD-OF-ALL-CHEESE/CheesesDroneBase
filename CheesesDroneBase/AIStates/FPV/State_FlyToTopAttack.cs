...
public class State_FlyToTopAttack : AITryState
{
    public override string Name => "Fly to Top Attack";
    ...
    public State_FlyToTopAttack(FPVDroneAI droneAI,
        float maxRange,
        float finalDistance,
        float finalHeight,
    ...
    private void UpdateTargetPos()
    {
        ...
        offset.y = 0;
        targetPos = offset.normalized * -finalDistance + droneAI.droneTargetBlackboard.target.position + Vector3.up * finalHeight;
    }
}
